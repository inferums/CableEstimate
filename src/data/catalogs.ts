...
/** Грунт по умолчанию: 2 группа, мокрого и сухого поровну — так считалось до
    появления параметров, поэтому старые проекты не меняют объёмы */
export const DEFAULT_SOIL = { group: 2, wetShare: 50 } as const;
...
export const CALC = {
  ...
  hdpeStickLength: 13, // длина плети трубы ПНД при поставке, м
  cableTieStep: 1, // шаг стяжек, скрепляющих пучок кабелей перед протяжкой, м
  ropeSlack: 2, // запас тягового троса с каждой стороны скважины, м
